"""
Django settings for coderDojoBack project.
...
ALLOWED_HOSTS = [
    ...
    '127.0.0.1',
    'web-production-67a5.up.railway.app'
]
...
AUTH_USER_MODEL = 'myclassroom.AppUser'
...
WSGI_APPLICATION = 'coderDojoBack.wsgi.application'
